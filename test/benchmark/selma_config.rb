...
module SelmaConfig
  ...
  class ImageMaxWidthManipulator
    SELECTOR = Selma::Selector.new(match: "img")
  ...
  class MentionManipulator
  end

  class EmojiManipulator
  end

  class SyntaxHighlightManipulator
  end
  ...
  ANCHOR_SCHEMES = %w[http https mailto xmpp].freeze
